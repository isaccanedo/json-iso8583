...
/**
 * ISO8583 is simple ISO 8583 parser and builder. 
 *
 */
public class ISO8583 
{
	...
	public ISO8583()
	{
		...
		if(ISO8583.generalConfig == null)
		{
			ISO8583.parseGeneralConfig();
		}
	}
	/**
	 ...
	 */
	public ISO8583(String mti_id, JSONObject config)
	{
		segment1[0] = 0;
		segment1[1] = 0;
		segment2[0] = 0;
	 ...
	 */
	public ISO8583(String mti_id, JSONObject config, String message)
	{
		segment1[0] = 0;
		segment1[1] = 0;
		segment2[0] = 0;
	 ...
	 * Get ISO8583 field
	 * @param field ISO8583 field number
	 * @return ISO8583Field contains field object
	 */
	...
	public void parse(String message)
	{
		...
		for(iter = 0; iter<this.fields.length; iter++)
		{
			...
			if(jo == null)
			{
				...
				if(ISO8583.generalConfig != null)
				{
					jo = (JSONObject) ISO8583.generalConfig.get("f"+field);
					if(jo == null)
					{
						validMessage = false;
					}
