...
public class Test {
	public static void main(String[] args) throws IOException {
		...
		try 
		{
			...
			System.out.println("Demonstração de conversão de ISO8583 para JSON e JSON para ISO8583");
			System.out.println("Definição das Configurações:");
			System.out.println(config.toString());
			System.out.println("=====================================================================================================================================");
			
			System.out.println("Mensagem ISO8583");
			System.out.println("'"+iso+"'");
			System.out.println("Converte ISO8583 para JSON");
			System.out.println("==>>RESULTADO EM JSON");
			System.out.println(json.toString());
			System.out.println("=====================================================================================================================================");
			
			System.out.println("Agora, converte JSON para novo ISO8583");
			System.out.println("RESULTADO EM ISO8583 : ");
